		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getModelAccess().getPackagedElementAssignment_0(), "rule__Model__PackagedElementAssignment_0");
					put(grammarAccess.getModelAccess().getPackagedElementAssignment_1(), "rule__Model__PackagedElementAssignment_1");
					...
					put(grammarAccess.getProperty_ImplAccess().getVisibilityAssignment_1(), "rule__Property_Impl__VisibilityAssignment_1");
					...
					put(grammarAccess.getOperationAccess().getVisibilityAssignment_1(), "rule__Operation__VisibilityAssignment_1");
					put(grammarAccess.getOperationAccess().getConcurrencyAssignment_2(), "rule__Operation__ConcurrencyAssignment_2");
					put(grammarAccess.getOperationAccess().getNameAssignment_3(), "rule__Operation__NameAssignment_3");
					put(grammarAccess.getClass_ImplAccess().getVisibilityAssignment_1(), "rule__Class_Impl__VisibilityAssignment_1");
					put(grammarAccess.getClass_ImplAccess().getNameAssignment_3(), "rule__Class_Impl__NameAssignment_3");
					put(grammarAccess.getClass_ImplAccess().getOwnedAttributeAssignment_5_2(), "rule__Class_Impl__OwnedAttributeAssignment_5_2");
					put(grammarAccess.getClass_ImplAccess().getOwnedAttributeAssignment_5_3_1(), "rule__Class_Impl__OwnedAttributeAssignment_5_3_1");
					put(grammarAccess.getClass_ImplAccess().getNestedClassifierAssignment_6_2(), "rule__Class_Impl__NestedClassifierAssignment_6_2");
					put(grammarAccess.getClass_ImplAccess().getNestedClassifierAssignment_6_3_1(), "rule__Class_Impl__NestedClassifierAssignment_6_3_1");
					put(grammarAccess.getClass_ImplAccess().getOwnedOperationAssignment_7_2(), "rule__Class_Impl__OwnedOperationAssignment_7_2");
					put(grammarAccess.getClass_ImplAccess().getOwnedOperationAssignment_7_3_1(), "rule__Class_Impl__OwnedOperationAssignment_7_3_1");
